...
import "./ProjectManagementPage.css"; // Keep your styling
...
const ProjectManagementPage = () => {
    ...
    if (loading) return <div className="text-center text-neutralgray-5 mt-4">...در حال بارگذاری</div>;
    if (error) return <div className="text-center text-red-500 mt-4">{error}</div>;

    if (!project) {
        return <div className="text-center text-gray-500 mt-4">پروژه یافت نشد یا در دسترس نیست.</div>;
    }
