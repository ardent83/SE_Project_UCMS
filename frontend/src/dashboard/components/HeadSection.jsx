...
export const HeadSection = ({ title, onClick, icon }) => {
    return (
        <div className="flex w-full h-[1.69613rem] items-center gap-[0.21175rem] px-[0.21175rem] py-0">
            <button onClick={onClick} className="flex justify-center items-center text-caption-04 text-[color:#2F80ED] cursor-pointer">
                {"<همه"}
            </button>
