...
import GradeReportPage from "./scores-list-page/GradeReportPage.jsx";
        ...
        <Routes>
          ...
          >
            ...
            <Route
              ...
              element={<ClassForm formType="edit" />}
            />
            <Route
              path="/class/:classId/project/create"
              element={<ProjectForm />}
            />
            <Route path="/class/:classId/exam/create" element={<ExamForm />} />
            <Route
              path="/class/:classId/exercise/create"
            ...
            <Route
              ...
              element={<ProjectForm formType="edit" />}
            />
            <Route
            ...
            <Route
              ...
              element={<GroupForm formType="edit" />}
            />
            <Route
              path="/project/:projectId/phase/create"
              element={<PhaseForm />}
            />
            <Route
            ...
            <Route
              path="/phase/edit/:phaseId"
              element={<PhaseForm formType="edit" />}
            />
            <Route
              path="/phase/:phaseId"
              element={
            ...
            {/* --- Exam Routes --- */}
            <Route
              path="/class/:classId/exam/edit/:examId"
              element={<ExamForm formType="edit" />}
            />
            <Route
            ...
            <Route
              ...
              element={<ExerciseForm formType="edit" />}
            />
