...
export default function GradeReportPage() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-4xl font-extrabold mt-6 mb-10 flex items-center border-b border-gray-200 pb-8 gap-3 justify-end text-blue-950">
        <span className='items-center'>گزارش نمرات</span>
      ...
      <div className="flex flex-wrap justify-between items-center mb-12 gap-6 relative z-20">
        ...
        {/* Using user's SearchBox component */}
        <SearchBox
          value={searchQuery}
      ...
      <div className="bg-white p-7 rounded-xl shadow-xl mb-12 overflow-x-auto border border-gray-100">
        ...
        <table className="min-w-full border-collapse text-right" dir="rtl">
      ...
      <div className="bg-white p-7 rounded-xl shadow-xl mb-12 overflow-x-auto border border-gray-100">
        ...
        <div className="overflow-y-auto max-h-[380px] relative z-10">
          <table className="w-full border-collapse text-right" dir="ltr">
            <thead className="sticky top-0 bg-white z-10">
              <tr className="border-b border-gray-300 text-gray-400 text-sm">
                <th className="py-3 px-4">نهایی</th>
